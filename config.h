...
static const int search_pl_count = 10;

/* volume step (percent) */
static const int vol_step = 5;

/* library path (~ is expanded) */
static const char *lib_dir = "~/Music/";
...
static const int col_smark_fg = COLOR_CYAN; /* song marker 's' */
static const int col_smark_bg = -1;
static const int col_plmark_fg = COLOR_MAGENTA; /* playlist marker 'p' */
static const int col_plmark_bg = -1;
static const int col_home_title_fg = COLOR_GREEN; /* home: "hum" title */
static const int col_home_title_bg = -1;
static const int col_home_sub_fg = COLOR_YELLOW; /* home: "by areofyl" */
static const int col_home_sub_bg = -1;
static const int col_home_key_fg = COLOR_GREEN; /* home: shortcut keys */
static const int col_home_key_bg = -1;
static const int col_home_sel_fg = COLOR_WHITE; /* home: selected item */
static const int col_home_sel_bg = COLOR_BLUE;
